...
#if    LWIP_DNS
#define   HOST_NAME       "a1D1UWZrv9c.iot-as-mqtt.cn-shanghai.aliyuncs.com"     //服务器域名
#else
#define   HOST_NAME       "47.102.164.191"     //服务器IP地址
#endif
...
#define   CLIENT_ID    "stm32|securemode=3,signmethod=hmacsha1,timestamp=1234567890|"      //随机的id
#define   USER_NAME      DEVICE_NAME "&" PRODUCT_KEY    //用户名
#define   PASSWORD      "A0DC49BB0868E5968107248A31A10CE2BD6E70EE"  //秘钥


#define   TOPIC_SUB          "/sys/" PRODUCT_KEY "/" DEVICE_NAME "/thing/service/property/set"     //订阅的主题
